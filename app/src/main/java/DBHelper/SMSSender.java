 ...
 * The SMSSender keeps track of when it is replicating and does not replicate multiple times.
 ...
 */
public class SMSSender extends AsyncTask<Void, Void, Object> {
...
//            c.moveToFirst();
            ...
            Cursor cursor = SurveyDBHelper.getFirst60Entries(context, SurveyDBHelper.EnergyEntry.SMSLOG_MOODCIRCLE);
            cursor.moveToFirst();
//            cursor.
//            int energyIndex = cursor.getColumnIndex(SurveyDBHelper.EnergyEntry.COLUMN_NAME_ENERGY);
//            int dateIndex7= cursor.getColumnIndex(SurveyDBHelper.EnergyEntry.COLUMN_NAME_TIME);
            ...
            while (!cursor.isAfterLast()) {
                ...
                try {
                    ...
                    data += "&" + URLEncoder.encode("message", "UTF-8") + "=" + URLEncoder.encode("7", "UTF-8");
                    //2 for Lauren
                    Log.v(TAG, data);
                ...
                try {
                    URL url = new URL("http://murphy.wot.eecs.northwestern.edu/~ywn3512/SMSgateway.py");
...
//  throw new UnsupportedOperationException("Not yet implemented");
                ...
                SurveyDBHelper.deleteNEntries(context, 1, SurveyDBHelper.EnergyEntry.SMSLOG_MOODCIRCLE);
                cursor.moveToNext();
            }
        }
        return null;
